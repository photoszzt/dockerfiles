...
# ( cd $BASE_DIR &&
#   docker build -t photoszzt/java-dev:jdk8-idea \
...
#     -f Dockerfile . )
# 
# docker push photoszzt/java-dev:jdk8-idea

( cd $BASE_DIR &&
  docker build -t photoszzt/java-dev:jdk11-idea \
...
# docker push photoszzt/java-dev:jdk11-idea
